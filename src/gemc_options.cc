...
void goptions::setGoptions()
{
	...
	optMap["SAVE_ALL_MOTHERS"].help += "                       Set to 2 to save in LUND format any particle that generate hits\n";
	optMap["SAVE_ALL_MOTHERS"].help += "                       Same as 2 but if a track’s mother also produced hits, only the mother is saved so the hits are not double counted\n";
