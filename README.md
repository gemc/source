...
<i> gemc can <a href="https://gemc.jlab.org/gemc/html/documentation/gdmlCadFactories.html">import models from CAD and GDML</a>.
   ...
   It can be <a href="https://gemc.jlab.org/gemc/html/examples/humanBody.html">imported in GEMC and made it sensitive</a> so that radiation doses can be measured.
