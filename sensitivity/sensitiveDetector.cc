...
int sensitiveDetector::processID(string procName)
{
	...
	if(procName == "hadElastic")       return 10;
	if(procName == "protonInelastic")  return 11;
	if(procName == "neutronInelastic") return 12;
	if(procName == "pi-Inelastic")     return 13;
	if(procName == "pi+Inelastic")     return 14;
	if(procName == "hIoni")            return 15;
	if(procName == "nCapture")         return 16;
	if(procName == "Decay")            return 17;
	if(procName == "muIoni")           return 18;
	if(procName == "CoulombScat")      return 19;
	if(procName == "Cerenkov")         return 20;
	if(procName == "dInelastic")       return 21;
	if(procName == "muPairProd")       return 22;
	if(procName == "ionIoni")          return 23;
	if(procName == "hPairProd")        return 24;
	if(procName == "tInelastic")       return 25;
	if(procName == "kaon-Inelastic")   return 26;
	if(procName == "kaon+Inelastic")   return 27;
	if(procName == "kaon0Inelastic")   return 28;
	if(procName == "kaon0LInelastic")  return 29;
	if(procName == "alphaInelastic")   return 30;
	if(procName == "lambdaInelastic")  return 31;
	if(procName == "sigma-Inelastic")  return 32;
	if(procName == "hBrems")           return 33;
	if(procName == "DecayWithSpin")    return 34;
