...
vector<identifier>  eic_compton_HitProcess :: processID(vector<identifier> id, G4Step* aStep, detector Detector)
{
...
map< string, vector <int> >  eic_compton_HitProcess :: multiDgt(MHit* aHit, int hitn)
{
...
map< int, vector <double> > eic_compton_HitProcess :: chargeTime(MHit* aHit, int hitn)
{
...
double eic_compton_HitProcess :: voltage(double charge, double time, double forTime)
{
	return 0.0;
}
